 ...
 * @author scr2
 */
@WebServlet(name="BandsMembersServlet", urlPatterns={"/BandsMembersServlet"})
public class BandsMembersServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String XMLFileName = path + "/Bands.xml";
            String XSLFileName = path + "/BandsMembers.xsl";
        ...
        DOMSource origDocSource = new DOMSource(doc);
            ...
            // Apply transform
            optimusPrime.setParameter("vBandName", bandName);
