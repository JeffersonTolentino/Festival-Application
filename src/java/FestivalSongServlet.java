 ...
 * @author Nathan
 */
@WebServlet(urlPatterns = {"/FestivalSongServlet"})
public class FestivalSongServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String XMLFileName = path + "/SetList.xml";
            String XSLFileName = path + "/SetList.xsl";
