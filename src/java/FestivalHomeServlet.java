 ...
 */
@WebServlet(urlPatterns = {"/FestivalHomeServlet"})
public class FestivalHomeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String XMLFileName = path + "/festival.xml";
            String XSLFileName = path + "/festivalhome.xsl";
